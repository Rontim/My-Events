...
export default function Event() {
  ...
  return (
    <div className="mb-0 border-x border-black dark:border-black">
      <div className="border-b border-black dark:border-black sticky top-0 z-50">
        <ul className="flex justify-between font-medium text-center text-gray-500 dark:text-gray-400">
          <li className="mr-2">
            <a
              href="#"

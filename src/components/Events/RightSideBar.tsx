...
const RightSideBar = () => {
  return (
    <aside className="h-full pb-32 w-72 max-[960px]:hidden dark:bg-gray-900 overflow-y-auto no-scrollbar max-[600px]:hidden  pt-24 p-4 space-y-4 fixed z-20 top-[0] right-0">
      <div

      ...
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
          ...
          <p className="mb-4">
            ...
            reinvent the wheel; we're here to make event planning and execution
            a breeze. Our team consists of strategists, designers, and
          ...
          <p>
            ...
            platform, you'll have the power to create unforgettable experiences
            without the usual hassle. Join us today and discover how effortless

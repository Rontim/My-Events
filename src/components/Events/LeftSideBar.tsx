...
const LeftSideBar = () => {
  return (
    <aside
      className="h-full pb-32 w-64 max-[960px]:w-36 dark:bg-gray-900 overflow-y-auto no-scrollbar max-[600px]:hidden  pt-24 max-[960px]:pt-20 p-4 space-y-4 fixed z-20 top-[0] left-0"
      // className="fixed left-0 flex flex-col justify-center items-center top-0 w-64 no-scrollbar h-screen pl-5 pt-24 dark:bg-gray-900 overflow-y-auto max-[960px]:pl-0 max-[960px]:py-16 max-[960px]:w-36  max-[600px]:hidden z-20"
      aria-label="Sidebar"
    >
      <ul className="space-y-6 ps-6 font-medium max-[960px]:space-y-8 max-[960px]:pt-12 ">
        <li>
          <Link
            href="/event"
            className="flex items-center max-[960px]:w-12 max-[960px]:h-12 p-2 text-gray-900 rounded-xl dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700  max-[960px]:rounded-full"
          >
            <svg

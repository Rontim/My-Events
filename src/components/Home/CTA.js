            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md">
                    ...
                    <p className="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                        Join us in crafting memorable experiences. Our platform makes event management a breeze. Whether you're
                        planning a conference, concert, or a small gathering, we've got you covered.
                    </p>
